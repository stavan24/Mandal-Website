function About() {
  return (
    <section id="about" className=" py-20 px-6 max-w-7xl mx-auto grid md:grid-cols-2 gap-10 items-center border-t border-orange-500/20 bg-">
      <div>
...
<br />
• Supports students’ education and moral development
<br />
...
<br />
• Located in a village near Sudhagad Fort
<br />
• Renovated and maintains a large Lord Rama temple
<br />
